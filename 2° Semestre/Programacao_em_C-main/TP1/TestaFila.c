...
float teste_aluno_novo_com_dados_validos() {
  ...
  Aluno *aluno = alu_novo(1, "AbraÃ£o", "ComputaÃ§Ã£o");

  if (aluno != NULL) {
    printf(
        "[Passou 1.50] - Teste da funÃ§Ã£o alu_novo() com dados vÃ¡lidos!\n");
    pontuacao = 1.5;
  } else {
    printf(
        "[Falhou 0.00] - Teste da funÃ§Ã£o alu_novo() com dados vÃ¡lidos!\n");
  }
  return pontuacao;
}
...
float teste_aluno_novo_com_dados_invalidos() {
  ...
  if (aluno == NULL) {
    printf(
        "[Passou 1.00] - Teste da funÃ§Ã£o alu_novo() com dados invÃ¡lidos!\n");
    pontuacao = 1;
  } else {
    printf(
        "[Falhou 0.00] - Teste da funÃ§Ã£o alu_novo() com dados invÃ¡lidos!\n");
  }
  return pontuacao;
}
...
float teste_aluno_novo_com_dados_nulos() {
  ...
  if (aluno == NULL) {
    printf("[Passou 0.67] - Teste da funÃ§Ã£o alu_novo() com dados nulos!\n");
    pontuacao = 0.67;
  } else {
    printf("[Falhou 0.00] - Teste da funÃ§Ã£o alu_novo() com dados nulos!\n");
  }
  return pontuacao;
}
...
float teste_aluno_acessa_com_dados_validos() {
  ...
  if (aluno != NULL) {
    ...
    if (matricula == 1 && strcmp(nome, "AbraÃ£o") == 0 &&
        strcmp(curso, "ComputaÃ§Ã£o") == 0) {
      printf("[Passou 1.50] - Teste da funÃ§Ã£o alu_acessa() com dados "
             "vÃ¡lidos!\n");
      pontuacao = 1.5;
    } else {
      printf("[Falhou 0.00] - Teste da funÃ§Ã£o alu_acessa()com dados "
             "vÃ¡lidos!\n");
    }
  } else {
    printf(
        "[Falhou 0.00] - Teste da funÃ§Ã£o alu_acessa() com dados vÃ¡lidos!\n");
  }
  return pontuacao;
}
...
float teste_aluno_atribui_com_dados_validos() {
  ...
  Aluno *aluno = alu_novo(1, "AbraÃ£o", "ComputaÃ§Ã£o");
  if (aluno != NULL) {
    alu_atribui(aluno, 2, "JacÃ³", "Sistemas de InformaÃ§Ã£o");
    alu_acessa(aluno, &matricula, nome, curso);
    if (matricula == 2 && strcmp(nome, "JacÃ³") == 0 &&
        strcmp(curso, "Sistemas de InformaÃ§Ã£o") == 0) {
      printf("[Passou 1.50] - Teste da funÃ§Ã£o alu_atribui() com dados "
             "vÃ¡lidos!\n");
      pontuacao = 1.5;
    } else {
      printf("[Falhou 0.00] - Teste da funÃ§Ã£o alu_atribui() com dados "
             "vÃ¡lidos!\n");
    }
  } else {
    printf("[Falhou 0.00] - Teste da funÃ§Ã£o alu_atribui() com dados "
...
float teste_aluno_atribui_com_dados_invalidos() {
  ...
  if (aluno != NULL) {
    ...
    if (matricula == 1 || strcmp(nome, "AbraÃ£o") == 0 ||
        strcmp(curso, "ComputaÃ§Ã£o") == 0) {
      printf("[Passou 1.00] - Teste da funÃ§Ã£o alu_atribui() com dados "
             "invÃ¡lidos!\n");
      pontuacao = 1;
    } else {
      printf("[Falhou 0.00] - Teste da funÃ§Ã£o alu_atribui() com dados "
...
float teste_aluno_atribui_com_dados_nulos() {
  ...
  if (aluno != NULL) {
    ...
    if (matricula == 1 && strcmp(nome, "AbraÃ£o") == 0 &&
        strcmp(curso, "ComputaÃ§Ã£o") == 0) {
      printf(
          "[Passou 0.67] - Teste da funÃ§Ã£o alu_atribui() com dados nulos!\n");
      pontuacao = 0.67;
    } else {
      printf(
          "[Falhou 0.00] - Teste da funÃ§Ã£o alu_atribui() com dados nulos!\n");
    }
  } else {
    printf(
        "[Falhou 0.00] - Teste da funÃ§Ã£o alu_atribui() com dados nulos!\n");
...
float teste_aluno_libera_com_dados_validos() {
  ...
  if (aluno != NULL) {
    printf(
        "[Falhou 0.00] - Teste da funÃ§Ã£o alu_libera() com dados vÃ¡lidos!\n");
    pontuacao = 0.0;
  } else {
    printf(
        "[Passou 1.50] - Teste da funÃ§Ã£o alu_libera() com dados vÃ¡lidos!\n");
    pontuacao = 1.5;
  }
  return pontuacao;
}
...
float teste_aluno_libera_com_dados_nulos() {
  ...
  alu_libera(&aluno);
  if (aluno == NULL) {
    printf("[Passou 0.67] - Teste da funÃ§Ã£o alu_libera() com dados nulos!\n");
    pontuacao = 0.67;
  } else {
    printf("[Falhou 0.00] - Teste da funÃ§Ã£o alu_libera() com dados nulos!\n");
  }
  return pontuacao;
}
...
float teste_fila_cria_com_dados_validos() {
  ...
  if (fila != NULL) {
    printf(
        "[Passou 1.00] - Teste da funÃ§Ã£o fila_nova() com dados vÃ¡lidos!\n");
    pontuacao = 1.0;
  } else {
    printf(
        "[Falhou 0.00] - Teste da funÃ§Ã£o fila_nova() com dados vÃ¡lidos!\n");
  }
  return pontuacao;
}
...
float teste_fila_libera_com_dados_validos() {
  ...
  fila_libera(&fila);
  if (fila != NULL) {
    printf("[Falhou 0.00] - Teste da funÃ§Ã£o fila_libera() com dados "
           "vÃ¡lidos!\n");
  } else {
    printf("[Passou 1.00] - Teste da funÃ§Ã£o fila_libera() com dados "
           "vÃ¡lidos!\n");
    pontuacao = 1;
  }
  return pontuacao;
...
float teste_fila_libera_com_dados_nulos() {
  ...
  if (fila_libera(NULL) == 0) {
    printf(
        "[Passou 0.50] - Teste da funÃ§Ã£o fila_libera() com dados nulos!\n");
    pontuacao = 0.50;
  } else {
    printf(
        "[Falhou 0.00] - Teste da funÃ§Ã£o fila_libera() com dados nulos!\n");
  }
  return pontuacao;
}
...
float teste_fila_vazia_com_dados_validos() {
  ...
  if (fila != NULL && fila_vazia(fila)) {
    printf(
        "[Passou 1.00] - Teste da funÃ§Ã£o fila_vazia() com dados vÃ¡lidos!\n");
    pontuacao = 1.0;
  } else {
    printf(
        "[Falhou 0.00] - Teste da funÃ§Ã£o fila_cheia() com dados vÃ¡lidos!\n");
  }
  return pontuacao;
}
...
float teste_fila_insere_com_dados_validos() {
  ...
  Fila *fila = fila_cria();
  if (fila != NULL) {
    Aluno *abraao = alu_novo(1, "AbraÃ£o", "ComputaÃ§Ã£o");
    if (fila_insere(fila, abraao) == 1) {
      Aluno *jaco = alu_novo(2, "Jaco", "ComputaÃ§Ã£o");
      if (fila_insere(fila, jaco) == 1) {
        Aluno *jose = alu_novo(3, "Jose", "ComputaÃ§Ã£o");
        if (fila_insere(fila, jose) == 1) {
          printf("[Passou 1.00] - Teste da funÃ§Ã£o fila_insere() com dados "
                 "vÃ¡lidos!\n");
          pontuacao = 1.0;
        } else {
          printf("[Falhou 0.00] - Teste da funÃ§Ã£o fila_insere() com dados "
                 "vÃ¡lidos!\n");
        }
      } else {
        printf("[Falhou 0.00] - Teste da funÃ§Ã£o fila_insere() com dados "
...
float teste_fila_insere_com_dados_invalidos() {
  ...
  if (fila != NULL) {
    ...
    Aluno *jaco = alu_novo(1, "Jaco", "ComputaÃ§Ã£o");
    if (fila_insere(fila, jaco) == 0) {
      printf("[Passou 0.67] - Teste da funÃ§Ã£o fila_insere() com dados "
             "invÃ¡lidos!\n");
      pontuacao = 0.67;
    }
  } else {
  ...
  if (fila_insere(fila, NULL) == -1) {
    ...
    if (fila_insere(NULL, abraao) == -1) {
      if (fila_insere(NULL, NULL) == -1) {
        printf("[Passou 0.50] - Teste da funÃ§Ã£o fila_insere() com dados "
               "nulos!\n");
        pontuacao = 0.50;
      } else {
        printf("[Falhou 0.00] - Teste da funÃ§Ã£o fila_insere() com dados "
      ...
      printf(
          "[Falhou 0.00] - Teste da funÃ§Ã£o fila_insere() com dados nulos!\n");
    }
  } else {
    printf(
        "[Falhou 0.00] - Teste da funÃ§Ã£o fila_insere() com dados nulos!\n");
    ...
    if (alu_igual(aluno, abraao) == 1) {
      ...
      if (alu_igual(aluno, jaco) == 1) {
        ...
        if (alu_igual(aluno, jose) == 1) {
          printf("[Passou 1.00] - Teste da funÃ§Ã£o fila_retira() com dados "
                 "vÃ¡lidos!\n");
          pontuacao = 1.0;
        } else {
          printf("[Falhou 0.00] - Teste da funÃ§Ã£o fila_retira() com dados "
                 "vÃ¡lidos!\n");
        }
      } else {
        printf("[Falhou 0.00] - Teste da funÃ§Ã£o fila_retira() com dados "
...
float teste_fila_retira_com_dados_nulos() {
  ...
  if (fila_retira(NULL) == NULL) {
    printf(
        "[Passou 0.50] - Teste da funÃ§Ã£o fila_retira() com dados nulos!\n");
    pontuacao = 0.50;
  } else {
    printf(
        "[Falhou 0.00] - Teste da funÃ§Ã£o fila_retira() com dados nulos!\n");
  }
  return pontuacao;
}
...
float teste_fila_primeiro_com_dados_validos() {
  ...
  if (fila != NULL) {
    ...
    if (alu_igual(aluno, abraao) == 1) {
      printf("[Passou 0.335] - Teste da funÃ§Ã£o fila_primeiro() com dados "
             "vÃ¡lidos!\n");
      pontuacao = 0.335;

    } else {
      printf("[Falhou 0.00] - Teste da funÃ§Ã£o fila_primeiro() com dados "
             "vÃ¡lidos!\n");
    }
  } else {
    printf("[Falhou 0.00] - Teste da funÃ§Ã£o fila_primeiro() com dados "
...
float teste_fila_primeiro_com_dados_nulos() {
  ...
  if (fila_primeiro(fila) == NULL) {
    ...
    printf(
        "[Falhou 0.00] - Teste da funÃ§Ã£o fila_primeiro() com dados nulos!\n");
  }
  ...
  if (fila != NULL) {
    ...
    if (aux != NULL) {
      ...
      if (matricula == 2 && strcmp(nome, "Jaco") == 0 &&
          strcmp(curso, "ComputaÃ§Ã£o") == 0) {
        printf("[Passou 1.00] - Teste da funÃ§Ã£o fila_busca() com dados "
               "vÃ¡lidos!\n");
        pontuacao = 1.0;
      } else {
        printf("[Falhou 0.00] - Teste da funÃ§Ã£o fila_busca() com dados "
               "vÃ¡lidos!\n");
      }
    } else {
      printf("[Falhou 0.00] - Teste da funÃ§Ã£o fila_busca() com dados "
    ...
    printf(
        "[Falhou 0.00] - Teste da funÃ§Ã£o fila_busca() com dados vÃ¡lidos!\n");
  }
  return pontuacao;
}
...
float teste_fila_busca_com_dados_invalidos() {
  ...
  if (fila != NULL) {
    ...
    if (aux == NULL) {
      printf("[Passou 0.67] - Teste da funÃ§Ã£o fila_busca() com dados "
             "invÃ¡lidos!\n");
      pontuacao = 0.67;
    } else {
      printf("[Falhou 0.00] - Teste da funÃ§Ã£o fila_busca() com dados "
...
float teste_fila_busca_com_dados_nulos() {
  ...
  if (aux == NULL) {
    printf("[Passou 0.50] - Teste da funÃ§Ã£o fila_busca() com dados nulos!\n");
    pontuacao = 0.50;
  } else {
    printf("[Falhou 0.00] - Teste da funÃ§Ã£o fila_busca() com dados nulos!\n");
  }
  return pontuacao;
}
